  ...
  <div>
    ...
    <v-container>
      ...
      <ul class="body-2">
        ...
        <li>当スクリムは毎週平日 1 回、土日 1 回、主催のYouTubeチャンネルにて公開スクリムを行う</li>
    ...
    <v-container>
      ...
      <ul class="body-2">
        ...
        <li>SNS等で当スクリムのリザルト画面の共有は禁止とする。ただしマッチング画面や待機画面の共有は可能とする</li>
        <li>当スクリムに関する過度な暴言や晒し行為をSNS等で上げる事を禁止する</li>
