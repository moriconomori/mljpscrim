<template>
  <div class="next-scrim">
    ...
    <v-card class="mx-auto pt-0 pb-0" outlined tile>
      ...
      <div class="d-flex justify-center align-center my-1">
        <v-card flat width="100%" class="d-flex flex-row-reverse align-center">
          <div>
        ...
        <v-card flat width="100%" class="d-flex align-center">
          <div>
